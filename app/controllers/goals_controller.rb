class GoalsController < ApplicationController
  def index
    ...
    @goals = @q.result(:distinct => true).includes(:user, :improvement_plan, :action_steps, :goal_comments).page(params[:page]).per(10)
  ...
  def create
    ...
    @goal.action_step = params[:action_step]
    @goal.comments = params[:comments]
